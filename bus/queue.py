...
class OutboundMessage:
    ...
    target_type: str | None = None  # qq notification: c2c / group
    conversation_id: str | None = None  # web routing guard for conversation switches
    request_id: str | None = None  # end-to-end correlation guard
    event_type: str = "assistant.message"
